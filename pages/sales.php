    ...
    <div class="container mt-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="modal-register-label">Eliminar Venta</h3>
                        <p class="modal">Edite los datos del Venta:</p>
                        <a data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></a>
                    </div>
                    <form id="formBorrar">
                        <div class="modal-body">
                            <p class="text-white contenido">¿Está seguro de que desea eliminar el Venta?</p>
        ...
        <div class="modal fade" id="modalCrud" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="modal-register-label">Editar Venta</h3>
                        <p class="modal">Edite los datos del Venta:</p>
                        <a data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></a>
                    </div>
                    <div class="modal-body">
                        <form role="form" id="formEditar" class="registration-form">
                            ...
                            <div class="form-group">
                                <label class="d-block" for="form-first-name">Productos: </label>
                                <input type="text" name="productE" class="w-100 text-center" id="productE">
                            </div>
                            <div class="form-group">
                                <label class="d-block" for="form-first-name">Total Compra: </label>
                                <input type="text" name="priceE" class="w-100 text-center" id="priceE">
                            </div>
                            <input type="hidden" id="tokenE" name="csrf_token" value="<?php echo $_SESSION['CSRF']; ?>">
                            <br>
                            <div class="modal-footer">
                                <input type="submit" class="btn btn-success" value=" Editar Venta ">
                                <input type="button" class="btn btn-warning" data-bs-dismiss="modal" aria-label="Close"
                                    value=" Cancelar ">
                            </div>
                        </form>
        ...
        <div class="modal fade" id="modalCrudAgregar" tabindex="-1" role="dialog" aria-labelledby="modal-register-label" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="modal-register-label">Agregar Venta</h3>
                        <p class="modal">Ingrese los datos del Venta:</p>
                        <a data-bs-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></a>
                    </div>
                    <div class="modal-body">
                        <form role="form" action="../security/CRUD/Rest.php" method="post" class="registration-form">
                            ...
                            <div class="form-group">
                                <label for="password" class="d-block">Productos:</label>
                                <input type="text" name="password" placeholder="Productos..." class="w-100" id="password" required>
                            </div>

                            <div class="form-group">
                                <label for="email" class="d-block">Total Compra:</label>
                                <input type="email" name="email" placeholder="Total..." class="w-100" id="email" required>
                            </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(document).on("click", ".editar", function () {
                    ...
                    products = fila.find("td:eq(2)").text();
                    price = fila.find("td:eq(3)").text();

                    $("#userE").val(userJS);
                    $("#productE").val(products);
                    $("#priceE").val(price);
                ...
                $(document).on("click", ".eliminar", function () {
                    ...
                    $(".contenido").text("¿Está seguro de que desea eliminar el Venta: " + userJS + "?");
                ...
                $("#formBorrar").submit(function (e) {
                    if (confirmDelete) {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: { id: idJS, opcion: opcion,csrf_token: token},
